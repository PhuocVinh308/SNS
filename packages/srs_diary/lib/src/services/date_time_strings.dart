...
class DateTimeStrings {
  final String postNoteFormat; // POST_NOTE_yyyymmdd_hhmmss_sss_xxx
  final String standardFormat; // yyyy-mm-dd hh:mm:ss

  DateTimeStrings(this.postNoteFormat, this.standardFormat);
}
...
DateTimeStrings generateBothDateTimeStrings() {
  ...
  final postNote = 'POST_ITEM_$yyyy$mm${dd}_$hh$mi${ss}_${sss}_$randomSuffix';
  final standard = '$yyyy-$mm-$dd $hh:$mi:$ss:$sss';

  return DateTimeStrings(postNote, standard);
}
